...
function getAverage(n1, n2) {
  return (
    n1 === 1.7976931348623157e308 && n2 === 1.7976931348623157e308
...
function getAngleBetweenVectors(x1, y1, x2, y2) {
  if (x2 - x1 < 0 && y2 - y1 > 0) return Math.acos(x2 - x1, y2 - y1) / 2;
  if (x2 - x1 === 0 && y2 - y1 < 0) return (Math.acos(x2 - x1, y2 - y1) * 2);
  if (x2 - x1 > 0 && y2 - y1 > 0) return Math.acos(x1 - x2, y1 - y2) / 2;
  return 0;
}
/*  it.optional('getAngleBetweenVectors should return a angle (in radians)
between two linear vectors', () => {
